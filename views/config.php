      ...
      <div class="ui special padded raised stack segment">
        <form class="ui form" role="configuration" action="#" method="POST">
          ...
          <div class="ui borderless shadowless segment">
            ...
            <div class="field">
              <label>
                ...
                <i class="tiny circular help icon link" role="popup" data-html="
                    ...
                    " width=650 data-variation="wide">
                </i>
              </label>
              <select class="ui dropdown" name="persist_notifications">
                <option value="platform-default" <?php
                ...
                <option value="yes-except-notification-manager-platforms" <?php
                                                                          if ((array_key_exists('persist_notifications', $onesignal_wp_settings) &&
          ...
          <div class="ui borderless shadowless segment">
                    ...
                    <i class="tiny circular help icon link" role="popup" data-html="
                       ...
                       <p>
                         <img
                            ...
                            width=400>
                       </p>" width=450 data-variation="flowing">
                    </i>
                  </label>
                </div>
              </div>
            ...
            <div class="field">
              <div class="ui toggle checkbox">
                <input type="checkbox" name="use_native_prompt" value="true" <?php if (array_key_exists('use_native_prompt', $onesignal_wp_settings) && $onesignal_wp_settings['use_native_prompt']) {
                                                                                echo "checked";
                                                                              } ?>>
