      ...
      <form class="ui form" role="configuration" action="#" method="POST">
        ...
        <div class="ui borderless shadowless segment">
          ...
          <div class="field">
            ...
            <input type="text" name="gcm_sender_id" placeholder="#############" value="<?php echo filter_var($onesignal_wp_settings['gcm_sender_id'], FILTER_SANITIZE_STRING); ?>">
          </div>
          <?php endif; ?>
          <div class="field">
            ...
            <input type="text" name="app_id" placeholder="xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxx" value="<?php echo filter_var($onesignal_wp_settings['app_id'], FILTER_SANITIZE_STRING); ?>">
          </div>
          <div class="field">
            ...
            <input type="text" name="app_rest_api_key" placeholder="xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx" value="<?php echo filter_var($onesignal_wp_settings['app_rest_api_key'], FILTER_SANITIZE_STRING); ?>">
          </div>
          ...
          <div class="field">
            ...
            <input type="text" name="safari_web_id" placeholder="web.com.example" value="<?php echo filter_var(@$onesignal_wp_settings['safari_web_id'], FILTER_SANITIZE_STRING); ?>">
          </div>
        </div>
        <div class="ui dividing header">
        ...
        <div class="ui borderless shadowless segment">
          ...
          <div class="field">
              ...
              <input type="text" name="notification_title" placeholder="<?php echo OneSignalUtils::decode_entities(get_bloginfo('name')); ?>" value="<?php echo filter_var(@$onesignal_wp_settings['notification_title'], FILTER_SANITIZE_STRING); ?>">
          </div>
          <div class="field">
            <div class="ui toggle checkbox">
        ...
        <div class="ui borderless shadowless segment">
          ...
          <div class="ui segment nb-feature nb-position-feature">
            ...
            <div class="field nb-feature nb-position-feature">
              ...
              <input type="text" name="notifyButton_offset_bottom" placeholder="20px" value="<?php echo filter_var(@$onesignal_wp_settings['notifyButton_offset_bottom'], FILTER_SANITIZE_STRING); ?>">
            </div>
            <div class="field nb-feature nb-position-feature nb-position-bottom-left-feature">
              ...
              <input type="text" name="notifyButton_offset_left" placeholder="20px" value="<?php echo filter_var(@$onesignal_wp_settings['notifyButton_offset_left'], FILTER_SANITIZE_STRING); ?>">
            </div>
            <div class="field nb-feature nb-position-feature nb-position-bottom-right-feature">
              ...
              <input type="text" name="notifyButton_offset_right" placeholder="20px" value="<?php echo filter_var(@$onesignal_wp_settings['notifyButton_offset_right'], FILTER_SANITIZE_STRING); ?>">
            </div>
          </div>
          ...
          <div class="ui segment nb-feature nb-color-feature">
            ...
            <div class="field nb-feature nb-color-feature">
              ...
              <input type="text" name="notifyButton_color_background" placeholder="#e54b4d" value="<?php echo filter_var(@$onesignal_wp_settings['notifyButton_color_background'], FILTER_SANITIZE_STRING); ?>">
            </div>
            <div class="field nb-feature nb-color-feature">
              ...
              <input type="text" name="notifyButton_color_foreground" placeholder="white" value="<?php echo filter_var(@$onesignal_wp_settings['notifyButton_color_foreground'], FILTER_SANITIZE_STRING); ?>">
            </div>
            <div class="field nb-feature nb-color-feature">
              ...
              <input type="text" name="notifyButton_color_badge_background" placeholder="black" value="<?php echo filter_var(@$onesignal_wp_settings['notifyButton_color_badge_background'], FILTER_SANITIZE_STRING); ?>">
            </div>
            <div class="field nb-feature nb-color-feature">
              ...
              <input type="text" name="notifyButton_color_badge_foreground" placeholder="white" value="<?php echo filter_var(@$onesignal_wp_settings['notifyButton_color_badge_foreground'], FILTER_SANITIZE_STRING); ?>">
            </div>
            <div class="field nb-feature nb-color-feature">
              ...
              <input type="text" name="notifyButton_color_badge_border" placeholder="white" value="<?php echo filter_var(@$onesignal_wp_settings['notifyButton_color_badge_border'], FILTER_SANITIZE_STRING); ?>">
            </div>
            <div class="field nb-feature nb-color-feature">
              ...
              <input type="text" name="notifyButton_color_pulse" placeholder="#e54b4d" value="<?php echo filter_var(@$onesignal_wp_settings['notifyButton_color_pulse'], FILTER_SANITIZE_STRING); ?>">
            </div>
            <div class="field nb-feature nb-color-feature">
              ...
              <input type="text" name="notifyButton_color_popup_button_background" placeholder="#e54b4d" value="<?php echo filter_var(@$onesignal_wp_settings['notifyButton_color_popup_button_background'], FILTER_SANITIZE_STRING); ?>">
            </div>
            <div class="field nb-feature nb-color-feature">
              ...
              <input type="text" name="notifyButton_color_popup_button_background_hover" placeholder="#CC3234" value="<?php echo filter_var(@$onesignal_wp_settings['notifyButton_color_popup_button_background_hover'], FILTER_SANITIZE_STRING); ?>">
            </div>
            <div class="field nb-feature nb-color-feature">
              ...
              <input type="text" name="notifyButton_color_popup_button_background_active" placeholder="#B2181A" value="<?php echo filter_var(@$onesignal_wp_settings['notifyButton_color_popup_button_background_active'], FILTER_SANITIZE_STRING); ?>">
            </div>
            <div class="field nb-feature nb-color-feature">
              ...
              <input type="text" name="notifyButton_color_popup_button_color" placeholder="white" value="<?php echo filter_var(@$onesignal_wp_settings['notifyButton_color_popup_button_color'], FILTER_SANITIZE_STRING); ?>">
            </div>
          </div>
        ...
        <div class="ui borderless shadowless segment">
          <div class="field">
            ...
            <input type="text" placeholder="forum,reply,topic  (comma separated, no spaces between commas)" name="allowed_custom_post_types" value="<?php echo filter_var(@$onesignal_wp_settings['allowed_custom_post_types'], FILTER_SANITIZE_STRING); ?>">
          </div>
          ...
          <div class="field custom-manifest-feature">
            ...
            <input type="text" placeholder="https://yoursite.com/manifest.json" name="custom_manifest_url" value="<?php echo filter_var(@$onesignal_wp_settings['custom_manifest_url'], FILTER_SANITIZE_STRING); ?>">
          </div>
          <div class="field">
            <div class="ui toggle checkbox">
